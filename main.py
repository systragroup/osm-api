...
from .road import (get_links_and_nodes,
                   clean_oneway,
                   clean_maxspeed,
                   clean_lanes,
...
from .bike import extended_bicycle_process, test_bicycle_process
...
def handler(event, context):
    ...
    if 'poly' in (event.keys()):
        log.info('restrict links to polygon')
